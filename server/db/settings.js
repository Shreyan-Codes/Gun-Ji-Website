...
const DEFAULTS = {
  ...
  home_gallery: [
    ...
    { src: "/assets/gunji_duo_stack.jpg", alt: "White and black GUN-जी t-shirts layered together", cap: "Premium cotton" },
    { src: "/assets/gunji_duo_detail.jpg", alt: "Close-up of the GUN-जी chest print", cap: "Chest print detail" },
    { src: "/assets/gunji_duo_street.jpg", alt: "GUN-जी t-shirts laid out on turf", cap: "Made for Nepal" },
  ],
};
